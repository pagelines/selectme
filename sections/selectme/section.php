...
*/
	...
	function section_template() {
		...
		$selectme = $this->opt('selectme_content') ? $this->opt('selectme_content') : 'shortlink';
		...
		if(
			...
			$leadingtext = $this->opt('selectme_leading_text') ? $this->opt('selectme_leading_text') : 'Shortlink:';
			$content = $shortlink;
		} elseif (
			$selectme == 'permalink'
			...
			$leadingtext = $this->opt('selectme_leading_text') ? $this->opt('selectme_leading_text') : 'Permalink:';
			$content = $permalink;
		} else { return; };


		$selectme_leading_class = $this->opt('selectme_leading_class') ? $this->opt('selectme_leading_class') : '';
		$selectme_content_class = $this->opt('selectme_content_class') ? $this->opt('selectme_content_class') : '';

		// Global div class
		$globalclass = $this->opt('selectme_global_class') ? $this->opt('selectme_global_class') : '';

		// Section Style Options
		$animationclass = $this->opt('selectme_animation');

		$align = $this->opt('selectme_align');

		$pad = $this->opt('selectme_pad') ? sprintf('padding: %s;', $this->opt('selectme_pad')) : '';
